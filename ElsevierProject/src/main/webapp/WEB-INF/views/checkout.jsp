	...
	<h1>Shipping details</h1>
		 ...
		 <form action="/sendShippingAddress">
		 	...
		 	<div class="column">
	            ...
	            <input type="text" name="firstName" id="firstName" size="30" value="<%=c.getFirstName() %>" required/> 
	          </div>
	          <div class="columns">
	             <label> Last Name * </label>
	            <input type="text" name="lastName" id="lastName" size="30" value="<%=c.getLastName() %>" required/>
	          </div>
