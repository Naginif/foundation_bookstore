...
As a registered user of a Service, Elsevier grants to you a non-transferable, non-exclusive and revocable license to use the Service according to the terms and conditions set forth in this Agreement. Except as expressly granted by this Agreement or otherwise by Elsevier or its licensors in writing, you acquire no right, title or license in the Service or any data, content, application or materials accessed from or incorporated in the Service.
<h3>Term and Termination</h3>
The license is effective until it expires, until Elsevier terminates it, or until you provide notice to Elsevier of your decision to terminate it. Your rights under this license will terminate automatically without notice to you if you fail to comply with any of the provisions of this Agreement. Elsevier reserves the right to suspend, discontinue or change a Service, or its availability to you, at any time without notice. Upon termination of the license to a Service, you shall cease all use of the Service.
<h3>No Assignment</h3>
THIS AGREEMENT IS PERSONAL TO YOU, AND YOU MAY NOT ASSIGN YOUR RIGHTS OR OBLIGATIONS TO ANYONE.
<h3>No Waiver</h3>
Neither failure nor delay on the part of Elsevier to exercise or enforce any right, remedy, power or privilege hereunder nor course of dealing between the parties shall operate as a waiver thereof, or of the exercise of any other right, remedy, power or privilege. No term of this Agreement shall be deemed waived, and no breach consented to, unless such waiver or consent shall be in writing and signed by the party claimed to have waived or consented. No waiver of any rights or consent to any breaches shall constitute a waiver of any other rights or consent to any other breach.
<h3>Severability</h3>
